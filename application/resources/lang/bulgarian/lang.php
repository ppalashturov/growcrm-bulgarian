...
return [
    ...
    'a_project_is_required_for_billable_expenses' => "Задължително да имате ПРОЕКТ (за платими разходи)",
    'accept_amendments' => "Приеми промените",
    'accept_estimate_confirm' => "Моля, потвърдете, че искате да приемте тази оферта",
    'accept_estimate' => "Приеми офертата",
    'accept' => "Приемам",
    'accepted' => "Прието",
    'account_has_been_suspended' => "Вашият профил е спрян!",
    'account_not_found' => "Профила не съществува!",
    'account_number' => "Номер на профила",
    'account_owner' => "Собственик на профила",
    'account_status' => "Статус на профила",
    'account' => "Профил",
    'action_items' => "Действие",
    'action_not_available_in_demo_mode' => "Тази заявка не е достъпна в ДЕМО режим.",
    'action_not_completed_errors_found' => "Заявката не може да бъде завършена!",
    'action_only_available_on_declined_estimates' => "Тази заявка е достъпна само при отказани оферти.",
    'action' => "Действие",
    'actions_not_available' => "Това действие не е достъпно в този ресурс.",
    'actions' => "Действия",
    'activate' => "Активиране",
    'active_leads' => "Активни запитвания",
    'active_projects' => "Активни проекти",
    'active_tasks' => "Активни задачи",
    'active_users' => "Активни потребители",
    'active' => "Активен",
    'activity' => "Действия",
    'add_a_new_category' => "Добави категория",
    'add_a_new_item' => "Добави продукт",
    'add_a_payment' => "Добави начин на палащне",
    'add_article' => "Създрай статия",
    'add_attachment' => "Добави прикачен файл",
    'add_category' => "Създай нова категория",
    'add_client_manager' => "Добави Мениджър към клиент",
    'add_client' => "Добави клиент",
    'add_comment' => "Добави коментар",
    'add_contact' => "Добави Контакт",
    'add_credit_note' => "Добави Кредитно известие",
    'add_department' => "Добави отдел",
    'add_due_date' => "Добави краен срок",
    'add_estimate' => "Създай оферта",
    'add_event' => "Добави събитие",
    'add_expense' => "Добави разход",
    'add_file' => "Добави файл",
    'add_invoice' => "Нова фактура",
    'add_item' => "Добави коментар",
    'add_knowledge_base' => "Създай нова статия",
    'add_knowledgebase_category' => "Добави категория в статии",
    'add_lead_source' => "Добави от къде идва запитването",
    'add_lead' => "Добави запитване",
    'add_lineitem_items_first' => "Първо добавете продукти за фактуриране.",
    'add_milestone_category' => "Добави категория в етап",
    'add_milestone' => "Добави нов етап",
    'add_new_item' => "Създай нов продукт",
    'add_new_lead_status' => "Добави нов статус на запитване",
    'add_new_lead' => "Добави ново запитване",
    'add_new_payment' => "Добави ново плащане",
    'add_note' => "Създай нова бележка",
    'add_payment' => "Добави плащане",
    'add_product' => "Създай нов продукт",
    'add_project' => "Създай нов проект",
    'add_role' => "Създай нова роля",
    'add_selected_items' => "Добави избраните продукти",
    'add_subscription' => "Създай нов абонамент",
    'add_tag' => "Добави етикет",
    'add_task' => "Добави нова задача",
    'add_tax_rate' => "Добави данъчна ставка",
    'add_taxrate' => "Нова данъчна ставка",
    'add_this_inside_your_dashboard' => "Добави този URL в началното табло.",
    'add_ticket' => "Отвори нов Тикет за поддръжка",
    'add_to_invoice' => "Добави към фактура",
    'add_url_inside_stripe' => "Добави този URL във вашият Stripe профил.",
    'add_user' => "Създай нов потребител",
    'add' => "Добави",
    'added_by' => "Добавено от",
    'added' => "Добавено",
    'additional_information' => "Допълнителна информация",
    'additional_settings' => "Допълнителни настройки",
    'address_and_organisation_details' => "Подробности за адрес и организация",
    'address' => "Адрес",
    'agree_to_terms' => "Съгласие с общите условия",
    'all_estimates' => "Всички оферти",
    'all_expenses' => "Всички разходи",
    'all_invoices' => "Всички фактури",
    'all_leads' => "Всички запитвания",
    'all_projects' => "Всички проекти",
    'all_setting_permissions_when_adding_project' => "Позволете на потребител да добавя клиенти и служител когато добавя проект.",
    'all_tasks' => "Всички задачи",
    'all_tickets' => "Всички въпроси",
    'all_time' => "Цялото време",
    'all' => "Всички",
    'allow_customers_to_signup' => "Позволи на клиента да се регистрира",
    'allow_editing_of_ticket_message' => "Позволи редакция на съобщение във въпроси за поддръжка",
    'allow_editing_of_ticket_subject' => "Позволи редакция на заглавие на въпрос за поддръжка",
    'allow_project_managers_to_edit_milestone' => "Позволи на управляващите проекти да променят и редактират етапите на проект",
    'allow_user_tags' => "Позволи на потребителите да добавят нови етикети",
    'allow_users_to_change_backgrounds' => "Позволи на потребителя да променя фона",
    'allow_users_to_change_language' => "Позволи на потребителя да променя езика",
    'allow_users_to_change_theme' => "Позволи на потребителя да променя темата",
    'allow_users_to_view_kb_when_not_logged_in' => "Позволи на потребителя вижда статиите без да влязъл в профила си",
    'allowed_avatar_file_type' => "Позволени файлови формати за профилна снимка (jpeg или png)",
    'allowed_file_types' => "Позволени файлови формати",
    'already_exists' => "вече съществуват",
    'already_have_an_account' => "Вече имате профил?",
    'amount_before_tax' => "Цена без ДДС",
    'amount' => "Стойност",
    'answered' => "Отговорен",
    'api_key' => "API ключ",
    'apostrophe' => "Апостроф",
    'app_settings' => "Настройки на системата",
    'app_version_could_not_be_veried' => "Версията на системата не може да бъде потвърдена.",
    'app' => "Начало",
    'application_backup_instructions' => "Може да направите архивно копие на системата през хостинг панела, който използвате.",
    'application_error' => "Възникна системна грешка при опит за обработка на тази заявка.",
    'apply_filter' => "Приложи филтър",
    'apply' => "Приложи",
    'april_short' => "Апр.",
    'april' => "Април",
    'archive_lead' => "Архивирай запитване",
    'archive_project' => "Архивирай проект",
    'archive_task' => "Архивирай задача",
    'archive' => "Архив",
    'archived' => "Архиви",
    'archives_leads' => "Архивирани запитвания",
    'archives_projects' => "Архивирани проекти",
    'archives_tasks' => "Архивирани задачи",
    'archives' => "Архиви",
    'are_you_sure_delete' => "Сигурни ли сте, че искате да изтриете този елемент?",
    'are_you_sure' => "Сигурни ли сте?",
    'Article Ordering' => "Подреждане",
    'article_not_found' => "Статията не може да бъде намерена.",
    'article_title' => "Заглавие",
    'article' => "Статия",
    'articles' => "Статии",
    'ascending_order' => "Възходящ ред",
    'assiged_manager_not_found' => "Присвоеният мениджър не можа да бъде намерен.",
    'assiged_user_not_found' => "Присвоеният потребител не можа да бъде намерен.",
    'assign_leads' => "Присвояванена запитвания",
    'assign_projects' => "Присвояванена проекти",
    'assign_tasks' => "Присвояванена на задачи",
    'assign_users' => "Присвояванена на потребители",
    'assign' => "Присвояване",
    'assigned_to_me' => "Възложено на мен",
    'assigned_to_you' => "Възложено на теб",
    'assigned_to' => "Възложено на",
    'assigned_user_permissions' => "Присвои права на потребители",
    'assigned_users' => "Присвои потребители",
    'assigned' => "Възложено",
    'assigning_users_to_a_task_info' => "Възложете задача на членовете на екипа, присвоени къмпроекта",
    'at' => "при",
    'attach_dettach' => "Прикрепи или отдели",
    'attach_receipt' => "Прикачете разписка/касова бележка",
    'attach_to_project' => "Добави към проект",
    'attach' => "Добави",
    'attachement' => "Прикачен файл",
    'attachments' => "Прикачени файлове",
    'august_short' => "Авг.",
    'august' => "Август",
    'available_to_all_clients' => "Достъпно за всички клиенти",
    'awaiting_feedback' => "Очаква се обратна връзка X",
    'back_to_login' => "Назад към вписване",
    'background' => "Изображения за фон",
    'balance_due' => "Остатък от дължима сума",
    'balance' => "Баланс",
    'bank' => "Банка",
    'banking_details' => "Банкови данни",
    'before_tax' => "Преди данъци",
    'best_image_dimensions' => "Препоръчителни размери на изображението",
    'bi Monthly' => "Два пъти в месеца",
    'bi_weekly' => "Два пъти в седмицата",
    'bill_an_expense' => "Разходни фактури",
    'bill_estimateid' => "Оферта номер",
    'bill_recurring_cycle_start_date' => "Начална дата за периодично фактуриране",
    'bill_recurring_cycles_explanation_1' => "Когато създавате за първи път периодична фактура, трябва да зададете начлна дата, за да започне повтарящият се цикъл. Следващите дати ще бъдат зададени автоматично, след като цикълът започне.",
    'bill_recurring_cycles_explanation_2' => "Фактури с падеж дни, които не присъстват в даден месец (напр. 29, 30, 31) ще бъдат генерирани на най-близката дата (напр. 28).",
    'bill_recurring_cycles_explanation_3' => "Първата издадена фактура е основна. Тази фактура ще бъде изпратена веднага след като се генереира.",
    'bill_recurring_grace_period_info' => "Период преди новосъздадената фактура да стане дължима за плащане",
    'bill_recurring_grace_period' => "Срок за плащане на периодична фкатура",
    'bill_recurring_period_info' => "Фактурата ще спре да се генерира след тоз брой цикли. За безкраен срок напишете 0",
    'bill_to' => "Фактура до",
    'billable_expenses' => "Платими разходи",
    'billable_hours_info' => "Това са всички часове, които все още не са фактурирани за този проект.",
    'billable_hours' => "Платими часове",
    'billable_time' => "Платимо време",
    'billable' => "Платимо",
    'billing_address' => "Адрес на фирма",
    'billing_type' => "Тип плащане",
    'billing' => "Плащане",
    'bin' => "Изтрий",
    'body' => "HTML скеция",
    'bulk_invoice_payments' => "Групово плащане по фактури",
    'calendar' => "Календар",
    'call_log' => "Списък с обаждания",
    'can_access_dashboard' => "Може да достъпи таблото",
    'can_only_be_set_as_global' => "Може да се зададе само като глобална настройка",
    'cancel_subscription' => "Спри абонамента",
    'cancel_upload' => "Спри качването",
    'cancel' => "Откажи",
    'cancelled' => "Отказани",
    ...
    'check_for_updates' => "Проверка за нови версии",
    ...
    'cronjob_settings' => "Cron Job Настройки",
    'cronjob_status' => "Cron Job Статус",
    'currency_code' => "Код на валутата",
    'currency_code' => "Код на валутата",
    'currency_symbol_position' => "Позиция на символа",
    'currency_symbol' => "Символ на валутата",
    'currency' => "Валута",
    'current_version' => "Текуща версия",
    'custom_fields' => "Персонализирани полета",
    'custom_form_fields' => "Персонализирани полета",
    'customer' => "Клиент",
    'customers' => "Клиенти",
    ...
    'date_is_not_valid' => 'невалидна дата',
    ...
    'delete_all_tasks' => "Изтрий всички задачи",
    ...
    'discount' => "Discount",
    'discounts' => "Discounts",
    'dismiss_notifications' => "Отхвърляне на всички известия",
    ...
    'download_updates' => "Изтегляне на актуализации",
    'download_updates' => "Изтегляне на актуализации",
    'download' => "Download",
    'draft' => "Draft",
    'drafts' => "Drafts",
    ...
    'edit_project' => "Редактирай проект",
    'edit_proposal' => "Edit Proposal",
    'edit_settings' => "Редактирай настройките",
    ...
    'event_uploaded_a_file' => "Качен файл",
    ...
    'general_variables' => "Основни променливи",
    ...
    'hours' => "Часа",
    'how_to_install_updates' => "Как да инсталирате актуализациите",
    'hr' => "Hr",
    'hrs' => "Hrs",
    'id' => "ID",
    ...
    'june_short' => "Jun",
    'june' => "June",
    'kanban_board_settings' => "Настройки на Kanban Board",
    'kanban_card_front_settings_info' => "Select the items that are shown on the front of each card, when viewing in Kanban mode",
    'kanban_pagination_limits' => "Kanban Boards - Лимит на страниците",
    'kanban_pagination_limits' => "Kanban Boards - Лимит на страниците",
    'kanban_view' => "Преглед на Kanban",
    'key_id' => "Key ID",
    ...
    'latest_payment' => "Последни плащания",
    'lead_id' => "Lead ID",
    ...
    'no_results_found' => "Упс - не бяха намерени записи",
    ...
    'payment_not_found' => "Плащането не може да бъде намереноF",
    'payment' => "Плащане",
    ...
    'project_settings' => "Настройки на проекта",
    ...
    'save' => "Запази",
    'search_term' => "Правила за търсене",
    'search' => "Търсене",
    ...
    'select_invoices' => "Избери фактури",
    ...
    'social_profile' => "Социален профил",
    'sort_by' => "Сортирай по",
    'sort' => "Sort",
    ...
    'system_notifications' => "Системни известия",
    'system' => "Система",
    'table_defaults' => "Таблица по подразбиране",
    ...
    'tags_settings' => "Настройки на таговете",
    'tags' => "Тагове",
    ...
    'task_settings' => "Настройки на Задачите",
    'task' => "Задача",
    'tasks_collaboration' => "Tasks Colloboration",
    'tasks' => "Задачи",
    'tax_amount' => "Данъчна сума",
    'tax_is_invalid' => "Данъкът е невалиден",
    ...
    'trash' => "Trash",
    'try_a_differet_search' => "Потърсете нещо друго",
    'try_again_later' => "Опитайте отново по-късно",
    'type' => "Тип",
    ...
    'units' => "Units",
    'unknown' => "Unknown",
    'update_avatar' => "Обнови аватар",
    'update_credit_card' => "Обнови Кредитна карта",
    'update_my_profile' => "Обнови профил",
    ...
    'zipcode' => "Zip Code",
    "update_settings" => "Актуализиране на настройките",
    ...
    'use_custom_settings' => "Използвай персонализирани настройки",
    'use_in_standard_form' => "Use in the standard form",
    'use_system_settings' => "Използвай системните настройки",
    ...
    'send_files' => "Изпрати файлове",
    'chat' => "Чат",
    'team_chat' => "Екипен чат",
